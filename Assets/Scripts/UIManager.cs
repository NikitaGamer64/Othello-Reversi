...
public class UIManager : MonoBehaviour
{
    ...
    public void SetPlayerText(Player currentPlayer)
    {
        ...
        {
            topText.text = "Ход чёрных <sprite name=DiscBlackUp>";
        }
        else if (currentPlayer == Player.White)
        {
            topText.text = "Ход белых <sprite name=DiscWhiteUp>";
        }
    }
    ...
    public void SetSkippedText(Player skippedPlayer)
    {
        ...
        {
            topText.text = "Нет ходов для чёрных <sprite name=DiscBlackUp>";
        }
        else if (skippedPlayer == Player.White)
        {
            topText.text = "Нет ходов для белых <sprite name=DiscWhiteUp>";
        }
    }
    ...
    public void SetWinnerText(Player winner)
    {
        ...
        {
            case Player.Black:
                winnerText.text = "Чёрные выиграли!";
                break;
            case Player.White:
                winnerText.text = "Белые выиграли!";
                break;
            case Player.None:
